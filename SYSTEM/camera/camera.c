...
int lastDletaAngle = 0, dletaAngle = 0, angle = 0;
...
//	if (DEBUG_SIGN & 0x02)
	...
	// printf(" mid =  %d  angle = %d  I=%.2f P=%.2f\n ", mid, angle, bias*0.01, (bias - lastBias) * 0.085);
	llB = lastBias;
...
void calculateMiddle() {
	static u16 i,j,Left=5,Right=123;
	static u16 value1_max,value1_min;
	
	value1_max=ADV[4];  //动态阈值算法，读取最大和最小值
	value1_min=ADV[4];  //最小值
